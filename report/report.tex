...
\begin{document}
	...
	To deblur and denoise our images using the $l_1$ wavelet regularization and either the Frobenius or Huber norm fidelity term, we employ the following algorithm:
