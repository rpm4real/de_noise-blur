...
\vspace{-3ex}
\begin{itemize}
\item Blur: $Ax$ is a discrete convolution of a Gaussian kernel with symmetric boundary conditions.
\item Noise: $w$ is noise drawn from a Gaussian distribution or a Student's t-distribution. 
\end{itemize}
\end{frame}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{../figures/changeLam.pdf}
\end{center}
...
\begin{textblock}{5}(0.9,10)
\rotatebox{90}{Cosine}
\end{textblock}

\begin{textblock}{5}(2.4,13.3)
$\lambda = 10^{-4}$
\end{textblock}

\begin{textblock}{5}(6.7,13.3)
$\lambda = 10^{-3}$
\end{textblock}
